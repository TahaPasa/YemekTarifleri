...
class ListeFragment : Fragment() {
    ...
    private lateinit var listeAdapter : ListeFragmentRecyclerAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        listeAdapter = ListeFragmentRecyclerAdapter(yemekIsmiListesi,yemekIdListesi)
    ...
    fun sqlVeriAlma()
    {
        ...
        try
        {
            ...
            }//istesen contect ile de yapabilirdin activity yerine
